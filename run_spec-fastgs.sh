...
CUDA_VISIBLE_DEVICES=0 OAR_JOB_ID=counter python train.py -s ./datasets/mipnerf360/counter -m ./output/counter -i images_4  --eval --densification_interval 500 --optimizer_type default --iterations 30000 --test_iterations 30000
