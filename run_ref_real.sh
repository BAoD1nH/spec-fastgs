...
# ============================================================
# SPEC-FASTGS REF-REAL BATCH SCRIPT
# Runs all available Ref-NeRF real scenes with images_4
# ============================================================

export CUDA_VISIBLE_DEVICES=0

DATA_ROOT=./datasets/Ref-NeRF/ref_real
OUTPUT_ROOT=./output/ref_real
IMAGES=images_4
...
for SCENE in "${SCENES[@]}"; do
    ...
    echo "========================================================================"
    echo " Starting spec-fastgs Ref-Real scene"
    echo "========================================================================"
